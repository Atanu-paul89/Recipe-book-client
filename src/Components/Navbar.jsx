...
const Navbar = () => {
    ...
    const links = (
        <div className='flex flex-col md:flex-row lg:flex-row items-center md:space-x-7 space-y-3 md:space-y-0'>
            ...
            <NavLink to={"/allrecipes"} className={linkClasses}>All Recipes</NavLink> 
            <NavLink to={"/addrecipe"} className={linkClasses}>Add Recipe</NavLink> 
            <NavLink to={"/myrecipes"} className={linkClasses}>My Recipes</NavLink> 
        </div>
    );
        ...
        <div className="navbar bg-gray-900 text-white py-2 px-4 md:px-8 lg:px-12 h-20 shadow-lg"> 
            <div className="navbar-start">
                ...
                <NavLink to={"/"} className="flex items-center gap-1 text-2xl font-extrabold text-blue-400">
                    <img src={logo} className='h-16 w-auto' alt="Recipe Book Logo" /> 
            ...
            <div className="navbar-end flex items-center">
                {user ? (
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="dropdown dropdown-end">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-gray-800 rounded-box z-[1] mt-3 w-52 p-2 shadow-lg text-gray-200">
                                <li><p className='font-bold text-blue-300'>Name: {user.displayName || 'N/A'}</p></li> 
                    ...
                    <div className="flex items-center space-x-3">
                        <NavLink to={"/login"} className="btn bg-blue-600 border border-blue-600 text-white rounded-lg hover:bg-blue-700 hover:border-blue-700 px-4 py-2 transition-colors duration-300 hidden md:inline-flex">Login</NavLink> 
                        <NavLink to={"/register"} className="btn bg-transparent border border-blue-400 text-blue-400 rounded-lg hover:bg-blue-600 hover:text-white px-4 py-2 transition-colors duration-300">Register</NavLink> 
                    </div>
                )}
            </div>
